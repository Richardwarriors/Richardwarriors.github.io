...
import {
  ...
  useSpring,
  useTransform,
} from "https://esm.sh/framer-motion@11?bundle";

const html = htm.bind(React.createElement);

const heroPortrait = "liuhaocun/liuhaocun_14.jpg";
const heroDetail = "liuhaocun/liuhaocun_24.jpg";
const heroAccent = "liuhaocun/liuhaocun_18.jpg";
          ...
          <div className="hero-grid">
            <div className="hero-copy">
              ...
              <${motion.div} className="hero-title-lockup" variants=${heroReveal}>
                ${titleLines.map(
                  (line, lineIndex) => html`
                    <div key=${`line-${lineIndex}`} className="title-line" aria-hidden="true">
                      ${line.map(
                        (letter, letterIndex) => html`
                          <${motion.span}
              ...
              <${motion.p} className="hero-description" variants=${fadeUp}>
                A cinematic digital feature shaped like an editorial cover story: precise,
                luminous, and built around Liu Haocun's calm magnetism across fashion,
                performance, and image-making.
              </${motion.p}>

              <${motion.div} className="cta-row" variants=${fadeUp}>
                <a className="button button-primary" href="#gallery">Explore Gallery</a>
                <a className="button button-secondary" href="#highlights">Watch Story</a>
              </${motion.div}>
            ...
            <div className="hero-visual">
              ...
              <${motion.div}
                ...
                style=${shouldReduceMotion ? undefined : { x: mediaX, y: mediaY }}
              >
                <div className="portrait-panel">
                  ...
                  <div className="portrait-caption">
                    ...
                    <strong>
                      Asymmetry, softness, and a fashion-house sense of restraint.
                    </strong>
                  </div>
                </div>
              </${motion.div}>
